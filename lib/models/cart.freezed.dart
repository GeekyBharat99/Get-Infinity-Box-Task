...
abstract class $CartCopyWith<$Res> {
  ...
  @useResult
  $Res call({String username, String token, List<Product> products});
}
...
class _$_Cart implements _Cart {
  ...
  @override
  String toString() {
    return 'Cart(username: $username, token: $token, products: $products)';
  }
...
abstract class _Cart implements Cart {
  const factory _Cart(
      ...
      final List<Product> products}) = _$_Cart;
